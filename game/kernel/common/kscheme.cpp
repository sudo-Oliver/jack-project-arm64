...
#elif defined __APPLE__ && defined __aarch64__
  // Darwin 25 W^X: MAP_JIT memory is only executable in exec mode.
  // Only flush icache when new JIT code was written since the last flush.
  if (g_ee_jit_code_dirty) {
